...
-- Initialize Rush Mode - Add Sprites in this Function 
rushmode = gideros.class(Sprite)
rushmode = Core.class(Sprite)

-- Arcade Mode Init Function - Every Sprite Goes In Here 
function rushmode:init()

	-- Go To Main Menu Button 
	local btn_go_to_mainmenu = Bitmap.new(Texture.new("ball4.png"))
