...
arcademode = gideros.class(Sprite)
arcademode = Core.class(Sprite)

-- Arcade Mode Init Function - Every Sprite Goes In Here 
function arcademode:init()

	-- Go To Main Menu Button 
	local btn_go_to_mainmenu = Bitmap.new(Texture.new("ball3.png"))
