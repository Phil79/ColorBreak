...
campaign = gideros.class(Sprite)
campaign = Core.class(Sprite)

-- Campaign Init Function - Every Sprite Goes In Here 
function campaign:init()

	-- Go To Main Menu Button 
	local btn_go_to_mainmenu = Bitmap.new(Texture.new("ball2.png"))
